...
while 1:
	...
	if message_chiffré_reçu:
		...
		n_de_Alice = message_reçu_en_int[len(message_chiffré_reçu_en_int)-1] #récuperer n d'alice
...
while 1:
    ...
    if message_de_bob:
        ...
        print("Voilà le message chiffré envoyé:",message_chiffré)
    if not message_chiffré_reçu:
        break
ma_socket.close()        	
